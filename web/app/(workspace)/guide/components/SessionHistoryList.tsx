      ...
      <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
        {sessions.map((session) => (
          <button
            ...
            className="text-left rounded-xl border border-slate-200 bg-white p-4 shadow-sm hover:shadow-md hover:border-primary/30 transition dark:border-slate-700 dark:bg-slate-800 dark:hover:border-primary/50"
          >
