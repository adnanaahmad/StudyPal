        ...
        <div className="shrink-0 flex items-center gap-1.5 pl-2 border-l border-slate-200 dark:border-slate-700">
          {canStart && (
            <button
              ...
              disabled={isLoading}
              className="inline-flex items-center gap-1 rounded-lg bg-primary px-3 py-1.5 text-xs font-medium text-white hover:opacity-90 disabled:opacity-50 transition"
            >
              {isLoading ? (
