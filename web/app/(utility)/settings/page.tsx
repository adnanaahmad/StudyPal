...
const TOUR_GUIDE_STEPS = [
  ...
  { target: "tour-complete", title: "4 / 4  —  Complete", desc: "When you are ready, click here to test and launch StudyPal." },
];
          ...
          <div className="mb-6 flex items-center justify-between rounded-xl border border-[var(--primary)]/20 bg-[var(--primary)]/5 px-5 py-4">
            <div>
              ...
              <p className="mt-1 text-[13px] text-[var(--muted-foreground)]">
                {t("Configure your endpoints below, run tests, then launch StudyPal.")}
              </p>
            </div>
            <button
